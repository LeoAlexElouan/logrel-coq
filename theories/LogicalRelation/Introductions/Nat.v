...
Definition natRed {Γ l} (wfΓ : [|- Γ]) : [Γ ||-S<l> tNat] :=
...
Section NatElimRedEq.
  Context {Γ} {wfΓ : [|-Γ]} {l P Q hs hs' hz hz'}
    ...
    (Rhz : [Γ ||-S<l> hz ≅ hz' : _ | RPQz])
    (RPQs : [Γ ||-S<l> elimSuccHypTy P ≅ elimSuccHypTy Q])
    (Rhs : [Γ ||-S<l> hs ≅ hs' : _ | RPQs ]) .
  ...
  Proof. 
    ...
    - intros t u  nfL nfR redL redR ? prop ih.
      ...
      + unshelve eapply irrLRConv, ih;
        first [eapply RPQext| eapply WAd_return, RPext]; tea; now symmetry.
    ...
    - intros; eapply redSubstTmEq.
      + eapply Wpack_return,SirrLR, Rhz.
