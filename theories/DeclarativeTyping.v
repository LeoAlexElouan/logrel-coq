...
(** The second, much stronger notion compares neutrals only "structurally".
  ...
  Inductive DeclNeutralConversion (Γ : context) : decl -> term -> term -> Type :=

  | neuConvRel (T : term) n : [|- Γ] -> in_ctx Γ n T -> [Γ |- tRel n ~ tRel n : T]
