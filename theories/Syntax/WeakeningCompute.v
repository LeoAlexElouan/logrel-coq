...
Definition dEval' Γ d n :=
  tTreeElim tNat (tLambda tNat (tRel O)) (dEvalNode' Γ n)
    d.
...
Lemma wk_dEvalNode' {Γ Δ n} (ρ : Δ ≤ Γ) :
  dEvalNode' Δ n⟨ρ⟩ = (dEvalNode' Γ n)⟨ρ⟩.
Proof.
  unfold dEvalNode'.
